...
export default function Navber() {
  ...
  return (
    <>
      {/* <nav className="bg-slate-200 border-gray-200 fixed top-0 right-0 left-0   text-slate-600">
  <div className="max-w-screen-xl flex flex-wrap items-center justify-between  md:justify-start  mx-auto p-4">
    <NavLink href="" className="flex items-center space-x-3 rtl:space-x-reverse pe-5">
    ...
    <div className="hidden w-full md:flex justify-between  md:w-auto bg-red-200 " id="navbar-default">
  <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg  md:flex-row md:space-x-4 rtl:space-x-reverse md:mt-0 md:border-0 ">
        <li>
          <NavLink to="" className="block py-2 px-3   rounded md:bg-transparent  md:p-0 ">Home</NavLink>
        </li>
        <li>
          <NavLink to="" className="block py-2 px-3  rounded  md:border-0  md:p-0 ">Cart</NavLink>
        </li>
        <li>
          <NavLink to="" className="block py-2 px-3  rounded  md:border-0  md:p-0 ">Products</NavLink>
        </li>
        <li>
          <NavLink to="" className="block py-2 px-3  rounded  md:border-0  md:p-0 ">Categories</NavLink>
        </li>
        <li>
          <NavLink to="" className="block py-2 px-3  rounded  md:border-0  md:p-0 ">Brands</NavLink>
        </li>
      </ul>
    </div>
  </div>
      ...
      {/* <nav className=" border-gray-200  fixed top-0 left-0 right-0 bg-slate-200 z-50">
        <div className="flex flex-wrap md:justify-between justify-center items-center mx-auto max-w-screen-xl p-4">
      ...
      {/* <Navbar className="border-gray-200 z-50  bg-[#2C3E50] dark:bg-gray-800 fixed top-0 text-white  left-0 right-0  p-9 ">
        ...
        >
          <span className="self-center navIgnore text-white text-2xl font-bold whitespace-nowrap uppercase ">
            Start Framework
          </span>
        </NavLink>
        ...
        <Navbar.Collapse >
          <NavLink
            to="about"
            active="true"
            className="block py-2 px-3 md:p-0 text-white uppercase  font-bold"
          >
            About
          </NavLink>
          <NavLink
